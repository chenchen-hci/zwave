...
This module is modified based on original bd_connect.py module, which is specially designed for zwave device connectors.

This module is a connector that connects zwave device to the Building DepotV3.1
Configuration:
...
class BdConnect:
    def __init__(self, data):
        ...
        self.data["home_id"] = self.sensor_data["home_id"]
        self.data["node_id"] = self.sensor_data["node_id"]
        self.data["node_name"] = self.sensor_data["node_name"]
        self.data["identifier"] = self.sensor_data["identifier"]
        self.sensor_data.pop("identifier")
        self.sensor_data.pop("node_name")
        self.sensor_data.pop("node_id")
        self.sensor_data.pop("home_id")
